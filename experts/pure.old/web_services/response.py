...
from experts.pure.web_services.common import validate_collection
...
def default(record: MutableMapping) -> Dict:
    ...
    Args:
        record: A mapping represenation of a Pure Web Services JSON record.
...
def transformer_for(*, collection: str, version: str = None) -> Callable[[MutableMapping], Dict]:
    ...
    Args:
        ...
        version: The Pure Web Services version, without the decimal point.

    Returns:
        A transformer function.

    Raises:
        common.PureWebServicesInvalidCollectionError: If the collection name is
            invalid for the given Web Services version.
        common.PureWebServicesInvalidVersionError: If the Web Services version number
            is unrecognized.
    '''

...
class AbstractResponseBodyParser():
    @staticmethod
    #def issn(body:AbstractResponseBody) -> str:
    def issn(body) -> str:
        return body['abstracts-retrieval-response']['item']['bibrecord']['head']['source']['issn']['$']

    @staticmethod
    #def issn_type(body:AbstractResponseBody) -> str:
    def issn_type(body) -> str:
        return body['abstracts-retrieval-response']['item']['bibrecord']['head']['source']['issn']['@type']

    @staticmethod
    #def refcount(body:AbstractResponseBody) -> int:
    def refcount(body) -> int:
        return body['abstracts-retrieval-response']['item']['bibrecord']['tail']['bibliography']['@refcount']

    @staticmethod
    #def reference_scopus_ids(body:AbstractResponseBody) -> list:
    def reference_scopus_ids(body) -> list:
        scopus_ids = []
        for ref in body['abstracts-retrieval-response']['item']['bibrecord']['tail']['bibliography']['reference']:
            itemid = ref['ref-info']['refd-itemidlist']['itemid']
            if itemid['@idtype'] == 'SGR':
                scopus_ids.append(itemid['$'])
        return scopus_ids

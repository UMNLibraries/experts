...
with Client() as session:
    ...
    print(f'{authored_assorted_results.success.keys()=}, {authored_assorted_results.defunct=}, {authored_assorted_results.error.keys()=}')
    ...
    cited_assorted_results = assorter.assort(
        session.get_many_abstracts_by_scopus_id(cited_scopus_ids)
    )
    print(f'{cited_assorted_results.success.keys()=}, {cited_assorted_results.defunct=}, {cited_assorted_results.error.keys()=}')
